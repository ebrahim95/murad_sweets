  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 text-center">
        ...
        {/* Tagline */}
        <p className="font-body text-lg sm:text-xl md:text-2xl lg:text-3xl text-brand-dark/80 mb-6 sm:mb-8 max-w-2xl mx-auto px-2 animate-fade-in-delay">
          Authentic Bangladeshi Mishti & Pithas
          <br />
          Luxury dessert tables, party trays, and bulk gift boxes for weddings,
          engagements, and special events.
        </p>

        {/* CTA Button - Order Link - 44px minimum touch target height */}
        <a
