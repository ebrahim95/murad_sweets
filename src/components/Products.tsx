        ...
        >
          ...
          <div className="space-y-3 font-body text-brand-dark/80">
            <p className="flex items-center justify-center gap-2">
              <svg className="w-5 h-5 text-accent-coral flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-6 pt-6 border-t border-brand-dark/10">
            ...
            <div className="space-y-3 font-body text-brand-dark/80">
              ...
              <p className="flex items-start justify-center gap-2">
                ...
                <a href="https://tiktok.com/@Murad.Sweets" target="_blank" rel="noopener noreferrer" className="hover:text-accent-coral transition-colors break-all">
                  @Murad.Sweets
                </a>
              </p>
              <p className="flex items-start justify-center gap-2">
                ...
                <a href="https://facebook.com/MuradSweets" target="_blank" rel="noopener noreferrer" className="hover:text-accent-coral transition-colors break-all">
                  Murad Sweets
                </a>
              </p>
            </div>
