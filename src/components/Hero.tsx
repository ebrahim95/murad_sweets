    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 text-center">
        ...
        >
          ...
          <br />
          Luxury dessert tables, party trays, and bulk gift boxes for weddings, engagements, and special events.
        </p>
        
        {/* CTA Button - WhatsApp Link - 44px minimum touch target height */}
        <a
          href="https://chat.whatsapp.com/JHSdHsgbOa1EnRdB7DGV8n?mode=gi_t"
          target="_blank"
          ...
          "
          aria-label="Join our WhatsApp group to order"
        >
          Order on WhatsApp
          <svg 
            className="w-5 h-5" 
